...
- **Accès administrateur**: création de compte, login, modification de mot de passe des comptes admin, CRUD portant sur les salariés, les services et les sites, recherche d'un salarié en fonction de son nom de famille.
